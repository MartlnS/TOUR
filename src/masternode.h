...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 1000TOUR, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 1000 TOUR - checking if valid masternode)
